...
class Search
{
    ...
    protected:
        ...
        virtual std::list<Node> getSuccessors(const Node& s, const Map& map, const EnvironmentOptions& options);
        virtual bool check(const Node& current, const Map& map, const EnvironmentOptions& options);
